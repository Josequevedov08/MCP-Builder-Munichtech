...
| 1:55 to 2:15 | File preview, click Download server.zip | "The AI only writes this small policy. The server code comes from templates that we compile and test, so it always builds and the security checks are always there." |
